"use strict";
var img1 = img_path + '1.jpg';
var img2 = img_path + '2.jpg';
var img3 = img_path + '3.jpg';
...
(function(d) {
    ...
    s = 0, (r = function(i, e) {
        ...
        return i = !0 === r.options.centerMode ? Math.floor(r.$list.width() / 2) : 0, n = -1 * r.swipeLeft + i, !0 === r.options.swipeToSlide ? (r.$slideTrack.find(".slick-slide").each(function(i, e) {
            var t, o;
            if (t = d(e).outerWidth(), o = e.offsetLeft, !0 !== r.options.centerMode && (o += t / 2), n < o + t) return s = e, !1
        ...
        !0 === i.options.dots && i.slideCount > i.options.slidesToShow && (d("li", i.$dots).on("click.slick", {
            message: "index"
        }, i.changeSlide), !0 === i.options.accessibility && i.$dots.on("keydown.slick", i.keyHandler)), !0 === i.options.dots && !0 === i.options.pauseOnDotsHover && i.slideCount > i.options.slidesToShow && d("li", i.$dots).on("mouseenter.slick", d.proxy(i.interrupt, i, !0)).on("mouseleave.slick", d.proxy(i.interrupt, i, !1))
        ...
        var e, t, o, n = this;
        if (!0 === n.options.centerMode ? !0 === n.options.infinite ? o = (t = n.currentSlide + (n.options.slidesToShow / 2 + 1)) + n.options.slidesToShow + 2 : (t = Math.max(0, n.currentSlide - (n.options.slidesToShow / 2 + 1)), o = n.options.slidesToShow / 2 + 1 + 2 + n.currentSlide) : (t = n.options.infinite ? n.options.slidesToShow + n.currentSlide : n.currentSlide, o = Math.ceil(t + n.options.slidesToShow), !0 === n.options.fade && (0 < t && t--, o <= n.slideCount && o++)), e = n.$slider.find(".slick-slide").slice(t, o), "anticipated" === n.options.lazyLoad)
        ...
        return t || (t = 0), this.slideCount <= this.options.slidesToShow ? void this.slideHandler(t, !1, !0) : void this.slideHandler(t)
    }, r.prototype.slideHandler = function(i, e, t) {
        var o, s, n, r, l, a = null,
            d = this;
        if (e = e || !1, !(!0 === d.animating && !0 === d.options.waitForAnimate || !0 === d.options.fade && d.currentSlide === i)) return !1 === e && d.asNavFor(i), o = i, a = d.getLeft(o), r = d.getLeft(d.currentSlide), d.currentLeft = null === d.swipeLeft ? r : d.swipeLeft, !1 === d.options.infinite && !1 === d.options.centerMode && (i < 0 || i > d.getDotCount() * d.options.slidesToScroll) ? void(!1 === d.options.fade && (o = d.currentSlide, !0 !== t && d.slideCount > d.options.slidesToShow ? d.animateSlide(r, function() {
            d.postSlide(o)
        }) : d.postSlide(o))) : !1 === d.options.infinite && !0 === d.options.centerMode && (i < 0 || i > d.slideCount - d.options.slidesToScroll) ? void(!1 === d.options.fade && (o = d.currentSlide, !0 !== t && d.slideCount > d.options.slidesToShow ? d.animateSlide(r, function() {
            d.postSlide(o)
        }) : d.postSlide(o))) : (d.options.autoplay && clearInterval(d.autoPlayTimer), s = o < 0 ? d.slideCount % d.options.slidesToScroll != 0 ? d.slideCount - d.slideCount % d.options.slidesToScroll : d.slideCount + o : o >= d.slideCount ? d.slideCount % d.options.slidesToScroll != 0 ? 0 : o - d.slideCount : o, d.animating = !0, d.$slider.trigger("beforeChange", [d, d.currentSlide, s]), n = d.currentSlide, d.currentSlide = s, d.setSlideClasses(d.currentSlide), d.options.asNavFor && ((l = (l = d.getNavTarget()).slick("getSlick")).slideCount <= l.options.slidesToShow && l.setSlideClasses(d.currentSlide)), d.updateDots(), d.updateArrows(), !0 === d.options.fade ? (!0 !== t ? (d.fadeSlideOut(n), d.fadeSlide(s, function() {
            d.postSlide(s)
        })) : d.postSlide(s), void d.animateHeight()) : void(!0 !== t && d.slideCount > d.options.slidesToShow ? d.animateSlide(a, function() {
            d.postSlide(s)
        }) : d.postSlide(s)))
        ...
        var i, e, t = this,
            ...
            n = t.length;
        for (i = 0; i < n; i++)
            if ("object" == (void 0 === o ? "undefined" : _typeof(o)) || void 0 === o ? t[i].slick = new r(t[i], o) : e = t[i].slick[o].apply(t[i].slick, s), void 0 !== e) return e;
        return t
    }
}),
function(s) {
    var o = function(i, e) {
        ...
        n = ["Ember", "Linda", "Elizabeth", "Susan", "Lisa", "Betty", "Emma", "Olivia", "Ava", "Isabella", "Sophia", "Mia", "Amelia", "Emily", "Evelyn", "Victoria", "Audrey"],
        r = ["added new photo", "uploaded new video", "feeling naughty", "started stream", "added new photo", "added new photo", "added new photo", "added new photo", "uploaded new video", "uploaded new video"],
        l = Date.now(),
        e = {
            girl0: [o(4, 7) + "k", "" + o(80, 180), "" + o(5, 20)],
            girl1: [o(5, 8) + "k", "" + o(100, 160), "" + o(10, 40)],
            girl2: [o(6, 10) + "k", "" + o(60, 100), "" + o(8, 55)]
        },
        t = function(i) {
            s(".statisticbox li:nth-child(1) span").first().html(e["girl" + i][0]), s(".statisticbox li:nth-child(2) span").first().html(e["girl" + i][1]), s(".statisticbox li:nth-child(3) span").first().html(e["girl" + i][2])
        };
    s(document).ready(function() {
        s(".feedbox__inner li").each(function(i, e) {
            var t = o(1, 4);
            switch (s(e).find(".feedbox__name").html(n[t]), t) {
                case 1:
                    s(e).find(".feedbox__img").attr("style", "background-image: url(" + img1 + ")");
                    break;
                case 2:
                    s(e).find(".feedbox__img").attr("style", "background-image: url(" + img2 + ")");
                    break;
                case 3:
                    s(e).find(".feedbox__img").attr("style", "background-image: url(" + img3 + ")");
                    break;
                case 4:
                    s(e).find(".feedbox__img").attr("style", "background-image: url(" + img1 + ")")
            }
            s(e).find(".feedbox__action").html(r[o(0, r.length)]), 0 === i && s(e).find(".feedbox__date").html(moment(l).fromNow()), 0 < i && s(e).find(".feedbox__date").html(moment(l - 72e3).fromNow()), 1 < i && s(e).find(".feedbox__date").html(moment(l - 10 * (i + i) * 216e3).fromNow())
        }), s(".slide__girl-name").each(function(i, e) {
            s(e).html(n[i + 1])
        }), t(0);
        var i = ["Hello, there!"];
        s(".sliderbox").not('.slick-initialized').slick({
            prevArrow: '<button type="button" class="slick-prev"><svg enable-background="new 0 0 256 256" version="1.1" viewBox="0 0 256 256" xml:space="preserve" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"><path d="M179.199,38.399c0,1.637-0.625,3.274-1.875,4.524l-85.076,85.075l85.076,85.075c2.5,2.5,2.5,6.55,0,9.05s-6.55,2.5-9.05,0  l-89.601-89.6c-2.5-2.5-2.5-6.551,0-9.051l89.601-89.6c2.5-2.5,6.55-2.5,9.05,0C178.574,35.124,179.199,36.762,179.199,38.399z"/></svg></button>',
            nextArrow: '<button type="button" class="slick-next"><svg enable-background="new 0 0 256 256" version="1.1" viewBox="0 0 256 256" xml:space="preserve" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"><path d="M76.8,217.6c0-1.637,0.625-3.274,1.875-4.524L163.75,128L78.675,42.925c-2.5-2.5-2.5-6.55,0-9.05s6.55-2.5,9.05,0  l89.601,89.6c2.5,2.5,2.5,6.551,0,9.051l-89.601,89.6c-2.5,2.5-6.55,2.5-9.05,0C77.425,220.875,76.8,219.237,76.8,217.6z"/></svg></button>'
        }), s(".sliderbox").on("afterChange", function(i, e) {
            t(e.currentSlide)
        }), s(".btnbox").addClass("fadeInUp"), s(".next").on("click", function(i) {
            var e, t, o;
            i.preventDefault(), e = s(this), t = e.closest(".step"), o = e.closest(".step").next(), t.hide(), o.fadeIn(500)
        });
        for (var e = 0; e < i.length; e++) console.log(i[e])
    })
}
(jQuery);